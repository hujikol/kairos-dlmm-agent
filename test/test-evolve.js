...
const TEST_RECORDS = [
  ...
  // ── Extra Winners (5) — added to reach MIN_EVOLVE_POSITIONS=15 ──
  {
    position:    "pos-win-4",
    pool:        "PoolW4",
    pool_name:   "WIN4/SOL",
  ...
  },
  {
    ...
    final_value_usd: 3.8,
    initial_value_usd: 3.0,
    minutes_in_range: 115,
    minutes_held:  165,
    close_reason: "take_profit",
    pnl_usd:     1.8,
    pnl_pct:     7.5,
    range_efficiency: 78.0,
  },
  {
    position:    "pos-win-6",
    pool:        "PoolW6",
    ...
    final_value_usd: 4.5,
    initial_value_usd: 3.0,
    minutes_in_range: 125,
    minutes_held:  195,
    close_reason: "take_profit",
    pnl_usd:     2.8,
    pnl_pct:     13.0,
    range_efficiency: 85.0,
  },
  {
    position:    "pos-win-7",
    pool:        "PoolW7",
    ...
    final_value_usd: 3.9,
    initial_value_usd: 3.0,
    minutes_in_range: 118,
    minutes_held:  170,
    close_reason: "take_profit",
    pnl_usd:     1.9,
    pnl_pct:     9.5,
    range_efficiency: 79.0,
  },
  {
    position:    "pos-win-8",
    pool:        "PoolW8",
    ...
    final_value_usd: 3.6,
    initial_value_usd: 3.0,
    minutes_in_range: 112,
    minutes_held:  160,
    close_reason: "take_profit",
    pnl_usd:     1.4,
    pnl_pct:     6.5,
    range_efficiency: 77.0,
  },

  // ── Extra Losers (5) — added to reach MIN_EVOLVE_POSITIONS=15 ──
  {
    position:    "pos-lose-3",
    pool:        "PoolL3",
    pool_name:   "LSE3/SOL",
  ...
  },
  {
    ...
    organic_score:  49,
    amount_sol:   0.35,
    fees_earned_usd: 0.09,
    final_value_usd: 0.85,
    initial_value_usd: 3.0,
    minutes_in_range: 15,
    minutes_held:  390,
    close_reason: "stop_loss",
...
async function runTest() {
  ...
  // Seed DB with 15 synthetic positions (8 winners, 7 losers)
  console.log("\nSeeding DB with 15 synthetic positions (8 winners, 7 losers)...");
...
async function runEdgeCaseTests() {
  ...
  // ── Edge case 2: Single position (winner) ──────────────────────────────────
  {
    ...
    try {
      ...
      const result = evolveThresholds(perfData, config);
      console.log("  Result:", JSON.stringify(result));
      // Single position has no comparison group, so MIN_EVOLVE_POSITIONS (15) not met
